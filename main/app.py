...
.big-title {text-align:center; font-size:28px; font-weight:700;}
.sub-title {text-align:center; color:gray; margin-bottom:20px;}
...
def extract_name(filename):
    korean_parts = re.findall(r"[가-힣]{2,4}", filename)
    if korean_parts:
